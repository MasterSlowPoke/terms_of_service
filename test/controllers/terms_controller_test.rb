...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { change_message: @term.change_message, date_end: @term.date_end, date_start: @term.date_start, text: @term.text }
    end
  ...
  test "should update term" do
    patch :update, id: @term, term: { change_message: @term.change_message, date_end: @term.date_end, date_start: @term.date_start, text: @term.text }
    assert_redirected_to term_path(assigns(:term))
  end
